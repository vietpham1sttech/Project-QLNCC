...
using Project_QLNCC.Web.Models.Account;
using Project_QLNCC.Web.Views.Shared.Components.TenantChange;

namespace Project_QLNCC.Web.Controllers
{
    public class AccountController : Project_QLNCCControllerBase
    {
