...
namespace Project_QLNCC.Migrations
{
    ...
    [Migration("20260501140333_Added_New_Fields_Supplier")]
    partial class Added_New_Fields_Supplier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_QLNCC.Suppliers.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Project_QLNCC.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Project_QLNCC.Authorization.Users.User", null)
                        .WithMany("Claims")
