...
{
    public abstract class Project_QLNCCWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Project_QLNCCWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Project_QLNCCWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Project_QLNCCDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Project_QLNCCDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Project_QLNCCDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Project_QLNCCDbContext, Task<T>> func)
        {
            T result;
